...
<table>
  <tr>
    <th width="34%">1. Знакомство с ботом</th>
    <th width="66%">2. Поиск, оценка и выбор квартиры</th>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td valign="top">
      ...
      платёж, инфраструктуру и итоговую AI-оценку с объяснением. Результаты
      приходят отдельными карточками со ссылкой на Krisha, а кнопки «Сохранить»
      и «Отклонить» записывают предпочтения пользователя, благодаря чему команда
      <code>/foryou</code> формирует более точную подборку.
    </td>
  </tr>
</table>
